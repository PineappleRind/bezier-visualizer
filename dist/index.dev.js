...
var Point = function Point(x, y, radius) {
...
function advance() {
  ...
  var calcedX1 = lerp(firstPoint[0], secondPoint[0], easedT);
  var calcedY1 = lerp(firstPoint[1], secondPoint[1], easedT);
  ...
  var calcedX2 = lerp(thirdPoint[0], firstPoint[0], easedT);
  var calcedY2 = lerp(thirdPoint[1], firstPoint[1], easedT);
  ...
  ctx.stroke();
  var finalCalcX = lerp(calcedX1, calcedX2, Math.abs(easedT - 1));
  var finalCalcY = lerp(calcedY1, calcedY2, Math.abs(easedT - 1));
  /*Trail*/
